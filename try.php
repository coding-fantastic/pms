            ...
            <div class="card-body">
                ...
                <form action="insertpdata.php" method="POST">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input class="form-control" type="text" value="Amount Paid" id="example-text-input" name="amountpaid">
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input class="form-control" type="text" value="Company name" id="example-text-input" name="companyname">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="example-text-input" class="col-sm-2 col-form-label">Phone 1</label>
                        <div class="col-sm-10">
                            <input class="form-control" type="text" value="Phone number" id="example-text-input" name="phone1" required>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="example-text-input" class="col-sm-2 col-form-label">Phone 2</label>
                        <div class="col-sm-10">
                            <input class="form-control" type="text" value="Phone number 2" id="example-text-input" name="phone2">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="example-text-input" class="col-sm-2 col-form-label">Phone 3</label>
                        <div class="col-sm-10">
                            <input class="form-control" type="text" value="Phone number 3" id="example-text-input" name="phone3">
                        </div>
                    </div>
                    <div class="form-group row">
